...
const FAQ_RESPONSES: Record<string, string> = {
  'how to use': 'To use FuelRoute: 1) Select your vehicle type, 2) Enter your journey details (from/to locations), 3) Click "Calculate Journey Cost". The app will show you fuel costs, distance, and CO₂ emissions!',
